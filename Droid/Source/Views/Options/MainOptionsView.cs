...
namespace KulGen.Droid.Source.Views.Options
{
	...
	public class MainOptionsView : NavigationBarView<MainOptionsView, MainOptionsViewModel>
	{
		...
		protected override void OnInitializeComponents ()
		{
			...
			var textInitTitle = FindViewById<TextView> (Resource.Id.text_init_title);
			var textMultiTitle = FindViewById<TextView> (Resource.Id.text_multi_title);

			textInitTitle.Text = ViewModel.InitTitle;
			textMultiTitle.Text = ViewModel.MultiNpcTitle;
			radioDesc.Text = ViewModel.InitDesc;
			radioAsc.Text = ViewModel.InitAsc;
			radioCheck.Text = ViewModel.InitCheckBox;
			radioNum.Text = ViewModel.MultiNpcNum;
			radioAlpha.Text = ViewModel.MultiNpcAlpha;
